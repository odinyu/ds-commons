...
public class ReflectUtils {
    ...
    public static <T> T getObjectByFieldName(Object object, String fieldName) {
        if (object != null && StringUtils.isNotEmpty(fieldName)) {
            try {
